	...
	public static void main(String args[]) {
		...
		do {
			System.out.println(nome
					+ ", você está preparado para a sua batalha? \n Para começar, escolha o seu Pokemon \n 1- Charmander \n 2- Sandshrew \n 3- Caterpie");
		...
		do {
			...
			case 4:
				...
				if (jogadores.get(partida % 2 * inimigo).getVida() == 0) {
					if (partida % 2 == 0)
						...
						System.out.println(
								"O pokémon inimigo '" + jogadores.get(partida % 2 * inimigo).getNome() + "' desmaiou!");
				}
			...
			if (jogadores.get(inimigo).getVida() == 0) { // lop infinito.
				jogadores.get(0).recebeXp(100); // involuir o pokémon do jogador
