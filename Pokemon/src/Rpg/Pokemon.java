...
public class Pokemon {
	...
	public Pokemon(String nome, double vida, double ataque, double defesa, double velocidade, double peso,
	...
	public void imprimirInfo() {
		...
		System.out.println("nome: " + this.getNome() + ", " + "tipo:" + this.getTipo() + ", " + "vida " + this.getVida()
				+ ", " + "peso: " + this.getPeso() + "Kg, " + "Altura: " + this.getAltura() + "M, " + "ataque: "
				+ this.getAtaque() + ", " + "defesa: " + this.getDefesa() + ", " + "Velocidade: "
				+ this.getVelocidade());
